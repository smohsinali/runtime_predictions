...
def plot(x, y, y_calculated, data_name, data_name_pred):
    ...
    plt.legend(loc='best')
    # plt.savefig("results/mc_" + data_name + "_pred_highres_wo2.png", dpi=300)
    plt.savefig("results/mc_" + data_name + "_pred_b2.png", dpi=200)
...
if __name__ == "__main__":
    ...
    data_name = input("Enter Dataset Name for which runtime prediction is done:")
